...
def PageChart(request):
	...
	context = {'retrait': retr,'depot':dep,'type1':retraitType,'type2':depotType,'retraitMois':retraitMois,'depotMois':depotMois,'dateNow':datetime.date(datetime.now()),'M_Now':Jours}
